# B. BigInteger+Rational [C++ fall 2023]
...
- составное присваивание с этими операциями. Деление должно работать не дольше, чем за $O(n^2)$ 
...
- литеральный суффикс `_bi` для написания литералов типа `BigInteger`
